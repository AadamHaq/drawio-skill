...
**HARD RULE: items must be ≥30px from parent left and right edges.** First item x ≥ band_x + 30. Last item right edge ≤ band_x + band_w - 30. Items touching the parent border look cramped and unprofessional.
